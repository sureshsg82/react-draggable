...
/***/ function(module, exports, __webpack_require__) {
	...
	var DraggableCore = function (_React$Component) {
	  ...
	  function DraggableCore() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DraggableCore.__proto__ || Object.getPrototypeOf(DraggableCore)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
	      ...
	      if (shouldUpdate === false) {
	        try {
	          // $FlowIgnore
	          _this.handleDragStop(new DragEvent('dragend'));
	        } catch (err) {
	          // Old browsers
	  ...
	  _createClass(DraggableCore, [{
	    ...
	    // Same as onDragStart (start drag), but now consider this a touch device.
	...
	DraggableCore.propTypes = {
	   ...
	   * with the exception of `onDragStart`, will not fire.
	   */
	  ...
	  /**
	   * A workaround option which can be passed if onDragStart needs to be accessed,
	   * since it'll always be blocked (as there is internal use of onDragStart)
	   */
